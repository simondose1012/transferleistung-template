...
Weil ich es kann\footcite{spektumperformance}\footcite{raspberrypischematics} verweise ich auf eine Quelle. % Die beiden leeren [][] in den Fußnoten-Zitaten werden benötigt, damit das nicht wiederholte Anzeigen von Zitaten in den Fußnoten korrekt funktioniert
